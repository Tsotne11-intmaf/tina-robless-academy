    ...
    <footer>
        ...
        <div className="wrap">
          <div className="foot-grid">
            <div><a className="logo" href="#home">Tina Robless</a><p style={{maxWidth: "34ch"}}>{t("თინა კუჭუხიზის ონლაინ კურსები — გრძელი ნაშენი, ფრენჩი და დიზაინი, თბილისიდან ყველგან.")}</p></div>
            <div><h4>{t("კურსები")}</h4><ul><li><a href="#catalog">{t("ყველა კურსი")}</a></li><li><a href="#catalog/technique">{t("ტექნიკა")}</a></li><li><a href="#catalog/art">{t("დიზაინი")}</a></li><li><a href="#catalog/business">{t("ბიზნესი")}</a></li></ul></div>
