/* Generated from the legacy single-file app: <main data-page="profile">.
...
export default function ProfilePage() {
  return (
    <>
      ...
      <section className="lms"><div className="wrap lms-grid">
        <aside className="side" id="side-profile"></aside>
        <div id="profile"></div>
      </div></section>
